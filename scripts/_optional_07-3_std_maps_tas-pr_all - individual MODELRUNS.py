...
for Varname_ESD in ['tas', 'pr']:
    for season in ['annual', 'summer', 'winter']:
        for confidence_level in confidence_levels:
            ...
            _dname = '%s_%s_valAtConfidenceLevel_%s_%s' % (Varname_ESD, model, confidence_level, season)
            ######################
            ...
            plot_map_negpos(t_pd, key_name='ref', dataset_name=_dname, cmap_name1='cubehelix', save=True, n_colors=20,
                            z_range=Z_RANGE, skip_rounding=True)
